...
Here is an example of what meter-based segmentation looks like over an audio feature and labeled chorus. Each meter becomes a slice of data fed into the neural network.
